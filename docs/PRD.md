...
| 구성 파일 | `core/inspection/{mtc_parser,sweep_shape,vision_check,reference,templates,grading,lot_builder}.py`, `ui/controllers/inspection_mixin.py`, `ui/widgets/{inspection_page,sweep_verdict_chart,sweep_explorer_window}.py`, `ui/dialogs/{inspection_template_dialog,image_popup_dialog}.py` |
