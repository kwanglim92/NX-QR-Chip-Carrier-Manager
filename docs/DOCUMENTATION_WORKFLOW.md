...
2. **Field PDF**: `docs/MC_QR_Manager_User_Guide_v2.4.0.pdf`
3. **Training deck**: `docs/training/` (있는 경우)
...
```html
<img src="assets/user-guide/inspection-mode.png" alt="Inspection mode result screen">
```
...
4. Export `docs/MC_QR_Manager_User_Guide_v2.4.0.pdf`.
...
& "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe" `
  --headless `
  --disable-gpu `
  --print-to-pdf="$PWD\docs\MC_QR_Manager_User_Guide_v2.4.0.pdf" `
